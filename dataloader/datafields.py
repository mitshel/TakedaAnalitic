...
{ 'name': 'Org_CustNm', 'title' : 'Заказчик торгов', 'type' : ft_string, 'fk' : '', 'cache' : cache_tender, 'group' : gr_Tender, 'visible' : 1, 'width' : 20},
...
{ 'name': 'Innr', 'title' : 'МНН', 'type' : ft_fk, 'fk' : fk_mnn, 'cache' : cache_tender, 'group' : gr_Spec, 'visible' : 1, 'width' : 10},
{ 'name': 'TradeNmR', 'title' : 'ТН', 'type' : ft_fk, 'fk' : fk_tm, 'cache' : cache_tender, 'group' : gr_Spec, 'visible' : 1, 'width' : 10},
