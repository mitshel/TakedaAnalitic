...
def bi_login(function=None, redirect_field_name=REDIRECT_FIELD_NAME, url=loginUrl):
    actual_decorator = user_passes_test(
        lambda u: (u.is_authenticated if settings.BI_AUTH else True),
...
def loginView(request):
    ...
    try:
        ...
        return render(request, 'bi_login.html', args)
...
def handler403(request, args):
    response = render(request, 'bi_login.html', args)
